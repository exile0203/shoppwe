        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6 border-b border-gray-200 pb-8">
          ...
          <div className="flex items-center flex-wrap gap-4">
            ...
            <button 
              ...
              className="flex items-center space-x-2 bg-white border border-red-200 text-red-600 px-6 py-2.5 rounded-full font-bold shadow-sm hover:bg-red-50 hover:border-red-300 transition-all active:scale-95"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
